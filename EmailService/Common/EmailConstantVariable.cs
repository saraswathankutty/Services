namespace ACI.Common
{
    public static class EmailConstantVariable
    {
        internal static string EMAIL_NAME = "AuthenticationEmail:Email";
        internal static string PASSWORD = "AuthenticationEmail:Password";
